...
// OPCIàN A: Pasando por VALOR (Ineficiente)
...
// OPCIàN B: Pasando por REFERENCIA (Puntero - Eficiente)
// Solo se copia la direcci¢n de memoria (8 bytes).
...
int main() {
    ...
    printf("\nCONCLUSIàN: Usar punteros fue %.2fx veces m s r pido.\n", tiempo_valor / tiempo_ref);
